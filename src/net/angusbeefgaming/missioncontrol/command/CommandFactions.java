...
public class CommandFactions extends Command {
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if(sender instanceof ProxiedPlayer) {
			...
			if (!player.getServer().getInfo().getName().equalsIgnoreCase(targetServer)) {
				...
				player.sendMessage(ChatColor.BLUE + "Portal> " + ChatColor.GRAY + "You have been sent from " + ChatColor.GOLD + oldServer + ChatColor.GRAY + " to " + ChatColor.GOLD + "Factions-1");
			}
			else {
